...
➡️ /docs/SRBM_Virtual_Nervous_System_Overview.md
...
The base layer allocates the resulting rigid‑body moments across the airframe’s multi‑effector control surfaces and propulsion elements. It runs at high rate (20 kHz) and is the only layer with direct actuator authority. It behaves like a reflex arc, stabilizing and shaping motion beneath conscious tactical reasoning.
